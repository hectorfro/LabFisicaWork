...
Supongamos que el encargado de negocios de una tienda de helados está interesado en estudiar  las operaciones de entrega y servicio de productos en las máquinas expendedoras de helados. El encargado sospecha que el tiempo que necesita un repartidor de ruta para cargar y dar servicio a una máquina está relacionado con el número de cajas de producto que debe entregar.  El encargado visita 25 puntos de venta elegidos al azar que tienen máquinas expendedoras y observa el tiempo de entrega en la salida (en minutos) y el volumen de producto entregado (en cajas) en cada uno de ellos. Las 25 observaciones se representan en la figura 1.1. Este gráfico se denomina diagrama de dispersión. Esta representación sugiere claramente que existe una relación entre el tiempo de entrega y el volumen de entrega; de hecho, da la impresión de que los puntos de datos caen generalmente, pero no exactamente, a lo largo de una línea recta, como se ilsutra en la misma figura.
